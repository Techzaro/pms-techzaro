                ...
                <table width="640" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:20px 34px 0;">
                            <p style="color:#6b7280;font-size:14px;line-height:1.6;margin:0 0 6px;">Dear <strong style="color:#111827;"><?php echo e($userName); ?></strong>,</p>

                            <p style="color:#374151;font-size:14px;line-height:1.7;margin:16px 0 20px;">A new deliverable has been added to one of your assigned <?php echo e($contextType); ?>.</p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <?php if($projectName): ?>
                                                <tr>
                                                    ...
                                                    <td style="padding:6px 0;color:#2563eb;font-size:13px;font-weight:600;"><?php echo e($projectName); ?></td>
                                                </tr>
                                            <?php endif; ?>
                                            <?php if($taskName): ?>
                                                <tr>
                                                    <td style="padding:6px 0;color:#6b7280;font-size:12px;font-weight:600;vertical-align:top;">Task</td>
                                                    <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600;"><?php echo e($taskName); ?></td>
                                                </tr>
                                            <?php endif; ?>
                                            <tr>
                                                <td style="padding:6px 0;color:#6b7280;font-size:12px;font-weight:600;vertical-align:top;">New Deliverable</td>
                                                <td style="padding:6px 0;">
                                                    <span style="display:inline-block;background-color:#f0fdf4;color:#16a34a;font-size:13px;font-weight:700;padding:3px 12px;border-radius:6px;"><?php echo e($deliverableName); ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;color:#6b7280;font-size:12px;font-weight:600;vertical-align:top;">Added By</td>
                                                <td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600;"><?php echo e($addedByName); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding:6px 0;color:#6b7280;font-size:12px;font-weight:600;vertical-align:top;">Date &amp; Time</td>
                                                <td style="padding:6px 0;color:#111827;font-size:13px;"><?php echo e($addedAt); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f9fafb;border-left:4px solid #16a34a;border-radius:0 8px 8px 0;margin:0 0 20px;">
                                    <tr>
                                        <td style="padding:14px 18px;">
                                            ...
                                            <p style="color:#374151;font-size:13px;line-height:1.6;margin:0;"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($deliverableDescription), 300)); ?></p>
                                        </td>
                                    </tr>
                                </table>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\PMS-project\backend\resources\views\emails\deliverable-added.blade.php ENDPATH**/ ?>