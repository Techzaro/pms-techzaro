...
class FixTenantColumns extends Command
{
    ...
    protected array $columnFixes = [
        'users' => [
            ...
            ['name' => 'password_reset_locked',          'definition' => "TINYINT(1) DEFAULT 0"],
            ['name' => 'password_changed_at',            'definition' => "TIMESTAMP NULL"],
            ['name' => 'password_version',               'definition' => "INT DEFAULT 1"],
        ],
        'tasks' => [
        ...
        'projects' => [
            ...
            ['name' => 'updated_by',                    'definition' => "BIGINT UNSIGNED NULL"],
            ['name' => 'project_code',                  'definition' => "VARCHAR(10) NULL"],
            ['name' => 'project_number',                'definition' => "INT UNSIGNED NULL"],
            ['name' => 'business_id',                   'definition' => "VARCHAR(50) NULL"],
            ['name' => 'sidebar_notes',                 'definition' => "TEXT NULL"],
            ['name' => 'client_name',                   'definition' => "VARCHAR(255) NULL"],
            ['name' => 'category',                      'definition' => "VARCHAR(255) NULL"],
            ['name' => 'budget',                        'definition' => "DECIMAL(10,2) NULL"],
