...
class EventController extends Controller
{
    ...
    public function unifiedCalendar(Request $request)
    {
        ...
        foreach ($tasks as $task) {
            $events->push([
                ...
                'date' => $this->fmtDate($task->start_date ?? $task->end_date),
                'start_date' => $this->fmtDate($task->start_date),
                'end_date' => $this->fmtDate($task->end_date),
                'status' => $task->status,
                ...
                'created_at' => $this->fmtDate($task->created_at),
                'updated_at' => $this->fmtDate($task->updated_at),
            ]);
        }
        ...
        foreach ($projects as $project) {
            $events->push([
                ...
                'date' => $this->fmtDate($project->start_date ?? $project->end_date),
                'start_date' => $this->fmtDate($project->start_date),
                'end_date' => $this->fmtDate($project->end_date),
                'status' => $project->status,
                'priority' => $project->priority,
                'assigned_users' => $project->assigned_users,
                'created_by' => $project->created_by,
                'creator_name' => $project->creator ? $project->creator->name : null,
                'created_at' => $this->fmtDate($project->created_at),
                'updated_at' => $this->fmtDate($project->updated_at),
            ]);
        }
        ...
        foreach ($deliverables as $deliverable) {
            $events->push([
                ...
                'date' => $this->fmtDate($deliverable->due_date),
                'start_date' => $this->fmtDate($deliverable->due_date),
                'end_date' => $this->fmtDate($deliverable->due_date),
                ...
                'submitted_at' => $this->fmtDate($deliverable->submitted_at),
                'approved_at' => $this->fmtDate($deliverable->approved_at),
                'rejected_at' => $this->fmtDate($deliverable->rejected_at),
                'created_at' => $this->fmtDate($deliverable->created_at),
                'updated_at' => $this->fmtDate($deliverable->updated_at),
            ]);
        }
    ...
    private function formatEventResponse(Event $event): array
    {
        ...
        return [
            ...
            'start_date' => $event->start_date ? $event->start_date->format('Y-m-d\TH:i:s') : null,
            'end_date' => $event->end_date ? $event->end_date->format('Y-m-d\TH:i:s') : null,
