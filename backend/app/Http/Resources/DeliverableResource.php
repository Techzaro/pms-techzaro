...
class DeliverableResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'acknowledged_at' => $this->acknowledged_at?->format('Y-m-d\TH:i:s'),
            'paused_at' => $this->paused_at?->format('Y-m-d\TH:i:s'),
            ...
            'last_timer_event_at' => $this->last_timer_event_at?->format('Y-m-d\TH:i:s'),
