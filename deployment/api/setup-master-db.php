...
$master->statement("INSERT INTO `organizations` (`name`, `slug`, `status`, `type`, `database_name`, `database_host`, `database_port`, `database_username`, `database_password`, `timezone`, `settings`, `created_at`, `updated_at`) VALUES ('TechXaro', 'techxaro', 'active', 'owner', 'techxaro_pmsv2_staging', '127.0.0.1', 3306, 'techxaro_pmsv2_staging', 'techxaro_pmsv2_staging', 'Asia/Karachi', '{\"subtitle\":\"PMS Portal\",\"org_name\":\"TechXaro\"}', NOW(), NOW())");
