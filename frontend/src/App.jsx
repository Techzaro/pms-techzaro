            ...
            <Routes>
              ...
              {onOrg && (
                <>
                  ...
                  <Route path="/org/:slug/hrm" element={<ProtectedRoute><HRMAdminLayout /></ProtectedRoute>}>
                    <Route index element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><HRMAdmin /></RoleProtectedRoute>} />
                    <Route path="recruitment" element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><RecruitmentOnboarding /></RoleProtectedRoute>} />
                    <Route path="offer-letters" element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><OfferLetters /></RoleProtectedRoute>} />
                    <Route path="workforce" element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><Workforce /></RoleProtectedRoute>} />
                    <Route path="documents" element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><EmployeeDocuments /></RoleProtectedRoute>} />
                    <Route path="attendance" element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><Attendance /></RoleProtectedRoute>} />
                    <Route path="applications" element={<RoleProtectedRoute allowedRoles={["admin", "owner", "manager", "hr_manager", "hr_user", "team_lead", "member"]}><Applications /></RoleProtectedRoute>} />
                    <Route path="my-applications" element={<RoleProtectedRoute allowedRoles={["admin", "owner", "manager", "hr_manager", "hr_user"]}><AdminMyApplications /></RoleProtectedRoute>} />
                    <Route path="workflow-settings" element={<RoleProtectedRoute allowedRoles={["admin", "owner"]}><WorkflowSettings /></RoleProtectedRoute>} />
                    <Route path="performance" element={<RoleProtectedRoute allowedRoles={["admin", "manager"]}><HrmPerformance /></RoleProtectedRoute>} />
                    <Route path="member-dashboard" element={<RoleProtectedRoute allowedRoles={["admin", "owner", "manager", "hr_manager", "hr_user", "team_lead", "member", "guest"]}><MemberHrmDashboard /></RoleProtectedRoute>} />
                  </Route>
