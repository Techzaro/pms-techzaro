...
function MemberExportReport({ isOpen, onClose, userData }) {
  ...
  const generatePDF = () => {
    ...
    try {
      ...
      doc.text("MY PERFORMANCE REPORT", PW / 2, 8, { align: "center" });
      doc.setFontSize(5.5); doc.setFont("helvetica", "normal");
      doc.setTextColor(148, 163, 184);
      const infoRX = PW - M;
      doc.text(`Generated On:  ${genDate}`, infoRX, 5, { align: "right" });
      doc.text(`Generated By:  ${genBy}`, infoRX, 9, { align: "right" });
      doc.text(`Report Type:  My Performance Report`, infoRX, 13, { align: "right" });
      y = 18;
      ...
      // ── TABLE ──
      doc.setFontSize(9); doc.setFont("helvetica", "bold");
      doc.setTextColor(17, 24, 39);       doc.text("MY TASKS & PROJECTS DETAILS", M, y + 2);
      y += 6;
      ...
      doc.setFontSize(8); doc.setFont("helvetica", "bold");
      doc.setTextColor(17, 24, 39);       doc.text("MY DELIVERABLES SUMMARY", M + 5, y + 7);
      const dItems = [
      ...
      doc.setFontSize(8); doc.setFont("helvetica", "bold");
      doc.setTextColor(17, 24, 39);       doc.text("MY DELIVERABLES DETAILS", drX + 5, y + 7);
      ...
      doc.text("Report Type:  My Performance Report", PW - M - 50, fY + 4);
      doc.text("Page 1 of 1", PW - M, fY + 7.5, { align: "right" });
      doc.save(`My-Performance-Report-${(user.name || "user").replace(/\s+/g, "-")}.pdf`);
    } catch (err) {
        ...
        <div className="er-overlay" onClick={onClose}>
          <div className="er-modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 560 }}>
            <div className="er-header">
              <div>
                <h2>Export Report</h2>
                <p>Select date range and review your performance report.</p>
              </div>
          ...
          <div className="er-review-modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 820 }}>
            ...
            <div style={{ padding: "0" }}>
              ...
              <div style={{ margin: "0 28px 14px" }}>
                <div style={{ fontSize: 12, fontWeight: 700, color: "#111827", marginBottom: 6 }}>MY TASKS & PROJECTS DETAILS</div>
              ...
              <div style={{ margin: "0 28px 14px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                {/* Left */}
                <div style={{ border: "1px solid #e5e7eb", borderRadius: 8, padding: "12px" }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: "#111827", marginBottom: 6 }}>MY DELIVERABLES SUMMARY</div>
                  {[
                ...
                {/* Right */}
                <div style={{ border: "1px solid #e5e7eb", borderRadius: 8, padding: "12px" }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: "#111827", marginBottom: 6 }}>MY DELIVERABLES DETAILS</div>
              ...
              <div style={{ borderTop: "1px solid #e5e7eb", margin: "0 28px", padding: "8px 0", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 9, color: "#9ca3af" }}>
                ...
                <div>Report Type:  My Performance Report | Page 1 of 1</div>
              </div>
