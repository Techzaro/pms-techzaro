...
export const plans = [
  ...
  { id: 2, name: 'Standard', slug: 'standard', price: 79, priceYearly: 790, maxUsers: 50, maxProjects: 50, maxStorage: 50, isDefault: false, isActive: true, modules: ['projects', 'tasks', 'deliverables', 'teams', 'events', 'notifications', 'chat', 'drafts', 'activities', 'profiles', 'company_documents', 'work_timers', 'reports', 'audit_logs', 'guest_portal', 'delegation'] },
...
export const modules = [
  { id: 1, name: 'Projects', slug: 'projects', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Full project lifecycle management with milestones, files, and visibility controls.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 2, name: 'Tasks', slug: 'tasks', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Task management with assignments, status tracking, timers, and submission workflows.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 3, name: 'Subtask', slug: 'deliverables', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Subtask management with delegation, approval chains, and file attachments.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 4, name: 'Teams', slug: 'teams', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Team organization with leaders, member assignments, and team-level views.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 5, name: 'Calendar & Events', slug: 'events', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Calendar with events, reminders, and unified scheduling across tasks and projects.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 6, name: 'Notifications', slug: 'notifications', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'In-app and push notifications with device token management.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 7, name: 'Chat', slug: 'chat', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Project-based messaging between team members and guests.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 8, name: 'Drafts', slug: 'drafts', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Draft system with auto-save, versioning, and publish workflows.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 9, name: 'Activity Feed', slug: 'activities', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Real-time activity tracking across all modules.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 10, name: 'User Profiles', slug: 'profiles', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Comprehensive user profiles with employment details and document management.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 11, name: 'Company Documents', slug: 'company_documents', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Company-wide document management for contracts, policies, and more.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 12, name: 'Work Timers', slug: 'work_timers', category: 'core', version: '1.0', isActive: true, isDefault: true, description: 'Time tracking with pause sessions, timer history, and productivity metrics.', supportedPlans: ['starter', 'standard', 'enterprise'] },
  { id: 13, name: 'Reports', slug: 'reports', category: 'standard', version: '1.0', isActive: true, isDefault: false, description: 'Advanced analytics with team performance, project reports, and export capabilities.', supportedPlans: ['standard', 'enterprise'] },
  { id: 14, name: 'Audit Logs', slug: 'audit_logs', category: 'standard', version: '1.0', isActive: true, isDefault: false, description: 'Complete audit trail with filtering, export, and compliance support.', supportedPlans: ['standard', 'enterprise'] },
  { id: 15, name: 'Guest Portal', slug: 'guest_portal', category: 'standard', version: '1.0', isActive: true, isDefault: false, description: 'Client-facing portal for external stakeholders to view assigned work.', supportedPlans: ['standard', 'enterprise'] },
  { id: 16, name: 'Delegation', slug: 'delegation', category: 'standard', version: '1.0', isActive: true, isDefault: false, description: 'Task and subtask delegation with approval chains and status tracking.', supportedPlans: ['standard', 'enterprise'] },
