...
const SelfTasks = () => {
  ...
  const filteredItems = useMemo(() => {
    ...
    return list;
  }, [searchFilteredItems, statusFilter, advancedFilters.priority, advancedFilters.priorities, pendingStatuses, inProgressStatuses, submittedStatuses, completedStatuses, pausedStatuses, declinedStatuses, abandonedStatuses]);
