/**
 * ProjectReopenDialog.jsx
 * Modal dialog for rejecting and reopening a project submission.
...
/**
 * Dialog for rejecting and reopening a project with feedback.
 * @param {boolean} isOpen - Whether the dialog is visible.
 * @param {Function} onClose - Callback to close the dialog.
 * @param {Object} project - The project being reopened.
    ...
    await run(async () => {
      try {
        ...
        if (res.ok) {
          ...
          notify.error(data.message || "Failed to reopen project.");
        }
      } catch {
