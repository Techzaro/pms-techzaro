    ...
    <div className="drm-overlay" onClick={onClose}>
      <div className="drm-modal" onClick={(e) => e.stopPropagation()}>
        <div className="drm-header">
          <h3>{t("Rename Draft", { defaultValue: "Rename Draft" })}</h3>
        ...
        <form onSubmit={handleSubmit}>
          <div className="drm-body">
            <label className="drm-label">{t("Draft Title", { defaultValue: "Draft Title" })}</label>
            <input
              type="text"
              className="drm-input"
              value={title}
              onChange={(e) => setTitle(e.target.value)}
              placeholder={t("Enter draft title...", { defaultValue: "Enter draft title..." })}
              autoFocus
            />
