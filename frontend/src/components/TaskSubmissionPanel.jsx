            ...
            <div className="td-submission-item" style={{ marginTop: "12px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginTop: "6px" }}>
                {fileAttachments.map((file) => (
                  <a key={`task-file-${file.id}`} className="td-submission-file-link" href={buildAttachmentUrl(file)} target="_blank" rel="noopener noreferrer">
                    <FileText size={16} />
            ...
            <div className="td-submission-item" style={{ marginTop: "12px" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", marginTop: "8px" }}>
                {imageAttachments.map((image) => (
                  <a key={`task-image-${image.id}`} href={buildAttachmentUrl(image)} target="_blank" rel="noopener noreferrer">
                    <img
            ...
            <div className="td-submission-item" style={{ marginTop: "12px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginTop: "6px" }}>
                {linkAttachments.map((link) => (
                  <a key={`task-link-${link.id}`} className="td-submission-file-link" href={buildAttachmentUrl(link)} target="_blank" rel="noopener noreferrer">
                    <span>{link.url}</span>
                  </a>
                ))}
              </div>
